            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CommentTitle = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    CommentRate = table.Column<int>(type: "int", nullable: false),
                    CommentDescription = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
